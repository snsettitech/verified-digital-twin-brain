    ...
    <div className="w-64 h-full bg-white border-r border-slate-200 flex flex-col shrink-0">
      <div className="p-6">
        <Link href="/dashboard" className="flex items-center gap-3 group">
          ...
          <span className="text-xl font-black tracking-tighter text-slate-800">VT-BRAIN</span>
        </Link>
      </div>
      ...
      <div className="p-4 mt-auto border-t border-slate-100">
        <div className="bg-slate-50 rounded-2xl p-4">
          <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Usage</div>
